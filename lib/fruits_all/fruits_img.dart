...
class food_img extends StatefulWidget {
  @override
  State<food_img> createState() => _food_imgState();
}

class _food_imgState extends State<food_img> {
                    ...
                    child: Container(
                      ...
                      child: onHover1( builder: (isHovered1,isClicked)
                      {
                        return   FloatingActionButton(
                          onPressed: () {
                             Navigator.push(context, MaterialPageRoute(builder:(context) => fruit_all_page() ,));
                          },
