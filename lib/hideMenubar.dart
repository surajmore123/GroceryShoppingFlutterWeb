...
class hideMenubar extends StatefulWidget {
  const hideMenubar({super.key});
  @override
  State<hideMenubar> createState() => _hideMenubarState();
}

class _hideMenubarState extends State<hideMenubar> {
          ...
          return InkWell(
              ...
              child: Padding(
                ...
                child: Text(
                  "Home",
                  style:
                      TextStyle(color: isHovered1 ? Colors.red : Colors.black),
                ),
              ));
        }),
        SizedBox(width: 80),
            ...
            Container(
              ...
              child: MenuItemButton(
                style: MenuItemButton.styleFrom(
                    shape: LinearBorder.bottom(size: 1, side: primarySide2)),
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                ...
                child: onHover(builder: (isHovered) {
                  return Text(
                    "All",
                    style:
                        TextStyle(color: isHovered ? Colors.red : Colors.black),
                  );
                }),
              ),
            ),
            ...
            return Container(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                      color:
                          isHovered1  ? Colors.red : Colors.black,
                ...
                Transform.rotate(
                  ...
                  child: Icon(
                    Icons.chevron_right,
                    size: 19,
                    color: isHovered1 || isClicked ? Colors.red : Colors.black,
                  ),
                )
              ],
            ));
...
//           }),
//         },
//         child: const Scaffold(body: SafeArea(child: hideMenubar())),
//       ),
//     );
//   }
// }
