...
import 'package:flutter_ls/menubar.dart';
import 'package:flutter_ls/nav.dart';
import 'package:flutter_ls/newmodel1.dart';
import 'package:http/http.dart' as http;
class baby_care_johnson_page extends StatefulWidget {
  @override
  State<baby_care_johnson_page> createState() => _baby_care_johnson_pageState();
}

class _baby_care_johnson_pageState extends State<baby_care_johnson_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 80, child: Text('baby-care')),
                                  ),
                                    Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 150, child: Text('Johnsons-Baby')),
                                  ),
                                ],
                              ),
                            ),
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('baby-care', 'johnsons-baby'),
