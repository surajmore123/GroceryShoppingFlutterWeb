...
class personal_c_soaps_page extends StatefulWidget {
  @override
  State<personal_c_soaps_page> createState() => _personal_c_soaps_pageState();
}

class _personal_c_soaps_pageState extends State<personal_c_soaps_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('personal-care', 'soaps-handwashes'),
