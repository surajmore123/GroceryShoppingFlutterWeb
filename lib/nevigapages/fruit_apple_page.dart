...
class fruit_apple_page extends StatefulWidget {
  @override
  State<fruit_apple_page> createState() => _fruit_apple_pageState();
}

class _fruit_apple_pageState extends State<fruit_apple_page> {
  List<Pro> prolist = [];
