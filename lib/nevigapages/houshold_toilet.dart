...
class household_toilet_page extends StatefulWidget {
  @override
  State<household_toilet_page> createState() => _household_toilet_pageState();
}

class _household_toilet_pageState extends State<household_toilet_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 150, child: Text('Toilet-And-Floor-Cleaners')),
                                  ),
                                ],
                              ),
                            ),
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('household-pets', 'toilet-and-floor-cleaners'),
