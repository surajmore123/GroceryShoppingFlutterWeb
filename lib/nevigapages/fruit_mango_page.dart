...
class fruit_mango_page extends StatefulWidget {
  @override
  State<fruit_mango_page> createState() => _fruit_mango_pageState();
}

class _fruit_mango_pageState extends State<fruit_mango_page> {
  List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('fruits', 'mangoes'),
