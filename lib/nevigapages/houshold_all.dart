...
class household_all_page extends StatefulWidget {
  @override
  State<household_all_page> createState() => _household_all_pageState();
}

class _household_all_pageState extends State<household_all_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 40, child: Text('Household-Pets')),
                                  ),
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('household-pets', ''),
