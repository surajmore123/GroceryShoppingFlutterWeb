...
class more_dry_f_page extends StatefulWidget {
  @override
  State<more_dry_f_page> createState() => _more_dry_f_pageState();
}

class _more_dry_f_pageState extends State<more_dry_f_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 80, child: Text('Dry-Fruits')),
                                  ),
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('dry-fruits', ''),
