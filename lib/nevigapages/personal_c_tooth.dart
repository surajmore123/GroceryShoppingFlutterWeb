...
class personal_c_tooth_page extends StatefulWidget {
  @override
  State<personal_c_tooth_page> createState() => _personal_c_tooth_pageState();
}

class _personal_c_tooth_pageState extends State<personal_c_tooth_page> {
    List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 150, child: Text('Tooth-Paste')),
                                  ),
                                ],
                              ),
                            ),
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('personal-care', 'tooth-paste'),
