...
class household_dishwash_page extends StatefulWidget {
  @override
  State<household_dishwash_page> createState() => _household_dishwash_pageState();
}

class _household_dishwash_pageState extends State<household_dishwash_page> {
      List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 80, child: Text('Household-Pets')),
                                  ),
                                    Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 150, child: Text('Dishwashing-Supplies')),
                                  ),
                                ],
                              ),
                            ),
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('household-pets', 'dishwashing-supplies'),
