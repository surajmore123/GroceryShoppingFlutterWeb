...
class more_diwali_page extends StatefulWidget {
  @override
  State<more_diwali_page> createState() => _more_diwali_pageState();
}

class _more_diwali_pageState extends State<more_diwali_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 80, child: Text('Diwali-Special')),
                                  ),
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('diwali-special', ''),
