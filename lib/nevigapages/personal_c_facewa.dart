...
class personal_c_facewas_page extends StatefulWidget {
  @override
  State<personal_c_facewas_page> createState() => _personal_c_facewas_pageState();
}

class _personal_c_facewas_pageState extends State<personal_c_facewas_page> {
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 80, child: Text('Personal-Care')),
                                  ),
                                    Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 150, child: Text('Soaps-Handwashes')),
                                  ),
                                ],
                              ),
                            ),
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('personal-care', 'facewash'),
