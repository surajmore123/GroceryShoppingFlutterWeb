...
class more_vegitable_page extends StatefulWidget {
  @override
  State<more_vegitable_page> createState() => _more_vegitable_pageState();
}

class _more_vegitable_pageState extends State<more_vegitable_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('vegetable', ''),
