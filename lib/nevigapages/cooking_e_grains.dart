...
class cooking_e_grains_page extends StatefulWidget {
  @override
  State<cooking_e_grains_page> createState() => _cooking_e_grains_pageState();
}

class _cooking_e_grains_pageState extends State<cooking_e_grains_page> {
  List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 80, child: Text('cooking-essentials')),
                                  ),
                                    Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 150, child: Text('grains-cereals-and-pulses')),
                                  ),
                                ],
                              ),
                            ),
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('cooking-essentials', 'grains-cereals-and-pulses'),
