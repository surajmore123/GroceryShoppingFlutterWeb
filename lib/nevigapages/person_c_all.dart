...
class personal_c_all_page extends StatefulWidget {
  @override
  State<personal_c_all_page> createState() => _personal_c_all_pageState();
}

class _personal_c_all_pageState extends State<personal_c_all_page> {
    List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 40, child: Text('Personal-Care')),
                                  ),
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('personal-care', ''),
