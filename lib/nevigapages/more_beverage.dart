...
class more_beverage_page extends StatefulWidget {
  @override
  State<more_beverage_page> createState() => _more_beverage_pageState();
}

class _more_beverage_pageState extends State<more_beverage_page> {
   List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('beverages', ''),
