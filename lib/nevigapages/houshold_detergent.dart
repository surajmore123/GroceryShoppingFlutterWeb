...
class household_detergent_page extends StatefulWidget {
  @override
  State<household_detergent_page> createState() => _household_detergent_pageState();
}

class _household_detergent_pageState extends State<household_detergent_page> {
    List<Pro> prolist = [];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    padding: const EdgeInsets.only(left: 7),
                                    child: Container(
                                        width: 150, child: Text('Detergent')),
                                  ),
                                ],
                              ),
                            ),
                            Expanded(
                              child: FutureBuilder(
                                future: getallproduct('household-pets', 'detergent'),
