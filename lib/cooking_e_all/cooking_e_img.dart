...
class cooking_e extends StatefulWidget {
  @override
  State<cooking_e> createState() => _cooking_eState();
}

class _cooking_eState extends State<cooking_e> {
    int currentIndex = 0;
            ...
            Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  FutureBuilder(
              future: getpostapi('cooking-essentials'),
