...
class personal_c extends StatefulWidget {
  @override
  State<personal_c> createState() => _personal_cState();
}

class _personal_cState extends State<personal_c> {
  int currentIndex = 0;
  ...
  Future<List<Produ>> getpostapi(String category) async {
    ...
    final response =
        await http.post(url, body: {'category': category.toString()});
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
              future: getpostapi('personal-care'),
